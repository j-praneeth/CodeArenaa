...
# New problems to add with comprehensive test cases including hidden ones
problems = [
    {
        "id": 4,
...
# Use the working MongoDB connection string
MONGODB_URI = "mongodb://localhost:27017/competitive-programming"

def add_problem_to_database(problem):
    """Add a single problem directly to MongoDB"""
    ...
    if result.upserted_id:
        print(f"Added new problem: {problem['title']}")
    else:
...
def main():
    print("Adding new problems to the database...")
    ...
    for problem in problems:
        try:
            add_problem_to_database(problem)
        except Exception as e:
            print(f"Error adding problem {problem['title']}: {e}")
    
    print(f"Finished adding {len(problems)} problems!")
